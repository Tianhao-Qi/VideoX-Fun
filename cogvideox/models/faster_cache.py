# Modified from https://github.com/huggingface/diffusers/blob/844221a/src/diffusers/hooks/faster_cache.py
...
from .wan_transformer3d import WanSelfAttention
...
_ATTENTION_CLASSES = (Attention, WanSelfAttention)
